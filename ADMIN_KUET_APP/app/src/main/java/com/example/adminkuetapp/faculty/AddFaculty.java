...
public class AddFaculty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Department", "CSE", "EEE", "ME", "CIVIL", "Other Departments"};
        ...
        addTeacherButton.setOnClickListener(view -> {
            checkValidation();
        ...
        if (account == null) {
            ...
            GoogleAccountCredential credential = GoogleAccountCredential
                    .usingOAuth2(AddFaculty.this, Collections.singleton(DriveScopes.DRIVE_FILE));
            ...
            driveServiceHelper = new DriveServiceHelper(googleDriveService, AddFaculty.this);
        }
    ...
    private void handleFileSelection(Uri fileUri) {
        if (fileUri != null) {
            ...
            if (mimeType != null && mimeType.startsWith("image/")) {
                ...
                addTeacherImage.setImageURI(fileUri);
            } else {
    ...
    private void handleSignInIntent(Intent data) {
        GoogleSignIn.getSignedInAccountFromIntent(data)
                ...
                .addOnFailureListener(e -> {
                    ...
                    Toast.makeText(AddFaculty.this, "Sign-in failed. Please try again.", Toast.LENGTH_SHORT).show();
                });
    }
    ...
    private void saveToFirebase(String fileUrl) {
        ...
        if (uniqueKey != null) {
            TeacherData teacherData = new TeacherData(name, email, post, fileUrl, uniqueKey);

            dbRef.child(uniqueKey).setValue(teacherData)
                    .addOnSuccessListener(aVoid -> {
                        Toast.makeText(this, "Teacher details uploaded  successfully in Firebase realtime database", Toast.LENGTH_SHORT).show();
                    })
                    .addOnFailureListener(e -> {
                        Toast.makeText(this, "Failed to save details of teacher in Firebase realtime database : " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
        } else {
            Toast.makeText(this, "Error: Failed to generate unique key.", Toast.LENGTH_SHORT).show();
        }

        //startActivity(new Intent(AddFaculty.this, UpdateFaculty.class));// gpt can you change it such that it back to previous activity??
        // Return to the previous activity instead of navigating forward
        finish();
    ...
    private class UploadFileTask extends AsyncTask<Uri, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (!result) {
                progressDialog.dismiss();
                Toast.makeText(AddFaculty.this, "Upload failed in Google Drive", Toast.LENGTH_SHORT).show();
            }
        }
    }
