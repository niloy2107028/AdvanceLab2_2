...
public class DriveServiceHelper {
    ...
    /**
     * Uploads a file to Google Drive from an InputStream.
     *
     * @param inputStream The input stream of the file to be uploaded.
     * @param fileUri     The URI of the file.
     * @param callback    A callback interface to handle success and failure.
     */
    ...
    /**
     * Determines the MIME type of a file from its URI.
     *
     * @param uri The URI of the file.
    ...
    /**
     * Retrieves the folder ID by folder name (e.g., "Notices").
     *
     * @param folderName The name of the folder to search for.
     * @return The folder ID if found.
     * @throws IOException If an error occurs while querying Google Drive.
     */
